<script lang="ts">
    ...
    async function login(event) {
        try {
            const loginData = new URLSearchParams(new FormData(event.target)).toString()
                ...
                <section id="signup" class="wrapper pt-8 pb-2">
                    <div class="col-lg-10 col-xl-8">
                        <form on:submit|preventDefault={login}>
                            <h2 class="display-5 mb-7">Login</h2>
                            <hr class="my-4" />
                            ...
                            <div class="form-label-group mt-2">
                                <button type="submit" class="btn btn-primary btn-sm rounded-pill me-1 mb-4 mb-md-0 mt-2">Login</button>
                            </div>
                            ...
                            {/if}
                            <div class="form-label-group mt-2">
                                <a href="/signup" use:link>Don't have an account?</a>
                            </div>
                        </form>
                    </div>
                </section>
